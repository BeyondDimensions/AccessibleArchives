# This is a script to convert PDFs into PNGs
...
def convert_pdf_page_to_png(pdf_document, page_number, pdf_output_folder):
    ...
    output_path = os.path.join(pdf_output_folder, f"page_{page_number + 1}.png")    # define output path
...
def convert_pdf_to_png(pdf_path, output_folder):
    ...
    pdf_name = os.path.splitext(os.path.basename(pdf_path))[0]  # extract PDf name from file without extention
