...
- make an option to pick a model and use it
- make it portable (webUI + desktopApp)
...
- Put documents on NAS and try to host an app in the network!
- Work on PyInstaller standalone app
